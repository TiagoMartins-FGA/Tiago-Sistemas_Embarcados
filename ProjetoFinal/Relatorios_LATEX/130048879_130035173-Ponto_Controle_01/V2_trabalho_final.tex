...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in, height=1.2in]{Imagens/baix}
\caption{Passa baixas} 
\flushleft{\small 
Fonte: \url{https://pt.wikipedia.org/wiki/Filtro_passa-baixo}}
\label{baixa}
\end{figure}

\begin{figure}[!htb]
\centering
\includegraphics[width=2.5in, height=1.2in]{Imagens/altas}
\caption{Passa alta} 
\flushleft{\small 
Fonte: \url{https://leoknuppe.wordpress.com/2013/12/16/projeto-filtro-passa-faixa/}}
\label{alta}
\end{figure}

\begin{figure}[!htb]
\centering
\includegraphics[width=2.5in, height=1.2in]{Imagens/banda}
\caption{Passa banda}
\flushleft{\small 
Fonte: \url{https://pt.wikipedia.org/wiki/Filtro_passa-faixa}}
\label{banda}
\end{figure}
